...
//     	observers.add(client);
     ...
     private void findPlaceForClient(Observer client) {
    	 ...
    	 Client cq=(Client)client;
//    	 System.out.println("size: "+cq.getTrajectory().size());
...
//        			if (i==0 && c.getTrajectory().size() < cd.getTrajectory().size()){
//        				observers.add(i, c);
//        				return;
//        			}
//        			int dirCD=chooseLeftOrRight(cd);
//        			System.out.println("size: cd "+cd.getTrajectory().size());
